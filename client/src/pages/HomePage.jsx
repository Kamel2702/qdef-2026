    ...
    <div className="mini-tinder">
      <div className="mini-tinder__stack">
        ...
        {[2, 1].map(offset => {
          ...
          return (
            <div key={`bg-${offset}`} className="mini-tinder__card mini-tinder__card--bg" style={{
              ...
              <img src={photos[idx % photos.length]} alt="" />
        ...
        <div
          ...
          onPointerUp={onUp}
        >
          <img src={photos[current % photos.length]} alt={speakers[current].name} />
          <div className="mini-tinder__card-overlay" />
...
const FALLBACK_PROGRAMME = [
  ...
  { id: 'p7', title: 'Quantum Sensing for Military Operations', type: 'keynote', start_time: '2026-11-25T14:00:00', end_time: '2026-11-25T14:40:00', speakers: [{ name: 'Dr. Anna-Lena Braun' }] },
  { id: 'p8', title: 'Cyber Warfare 2030: Threats & Defenses', type: 'panel', start_time: '2026-11-25T14:40:00', end_time: '2026-11-25T15:20:00', speakers: [{ name: 'George Kurtz' }, { name: 'Nikesh Arora' }] },
  { id: 'p9', title: 'Ethics of Autonomous Defence Systems', type: 'panel', start_time: '2026-11-25T15:50:00', end_time: '2026-11-25T16:30:00', speakers: [{ name: 'Dr. Andrea Renda' }] },
  { id: 'p10', title: 'Luxembourg as Cybersecurity Hub', type: 'keynote', start_time: '2026-11-25T16:30:00', end_time: '2026-11-25T17:10:00', speakers: [{ name: 'Yuriko Backes' }] },
  { id: 'p11', title: 'Closing Ceremony & Key Takeaways', type: 'keynote', start_time: '2026-11-25T17:10:00', end_time: '2026-11-25T17:40:00', speakers: [{ name: 'Yuriko Backes' }] },
  { id: 'p12', title: 'Networking Reception & Cocktail', type: 'break', start_time: '2026-11-25T17:40:00', end_time: '2026-11-25T19:00:00', speakers: [] },
];
...
export default function HomePage() {
  ...
  useEffect(() => {
    const target = new Date('2026-11-25T09:00:00+01:00');
    const tick = () => {
    ...
    <>
        ...
        <div className="hero__content hero__content--split">
          ...
          <div className="hero__left">
            ...
            <h1 className="hero__title">
              The summit<br />shaping <strong>quantum<br />defense.</strong>
            </h1>
            <p className="hero__subtitle-text">
              300+ leaders in cybersecurity, quantum computing, and defense
              gather at Maison du Savoir, Esch-sur-Alzette.
            </p>
            <div className="hero__actions">
              <Link to="/register" className="btn btn-gradient btn--lg">Attend the Event</Link>
              <Link to="/programme" className="btn btn-outline-light btn--lg">Programme</Link>
            </div>
          ...
          <div className="hero__right">
            <div className="hero-visual">
              ...
              <div className="hero-visual__label">Q-DEF<br /><span>2026</span></div>
              {/* Speaker photos orbiting */}
              {speakers.slice(0, 4).map((sp, i) => (
                <div
                  key={sp.id || i}
                  className="hero-orbit-photo"
                  style={{ '--orbit-delay': `${i * -2.5}s`, '--orbit-distance': `${38 + i * 4}%` }}
                >
                  <img src={PHOTOS[i]} alt={sp.name} />
      ...
      <section className="stats-bar">
        <div className="container stats-bar__inner">
          {[{ n: '300+', l: 'Attendees' }, { n: '17', l: 'Speakers' }, { n: '19', l: 'Sessions' }, { n: '6', l: 'Tracks' }, { n: '15+', l: 'Nations' }].map(({ n, l }) => (
      ...
      {/* ===== SPLIT: ABOUT LEFT + SPEAKERS RIGHT ===== */}
      <section className="section" ref={r('split')} data-s="split">
        <div className="container">
          <div className={`home-split ${a('split')}`}>
            {/* Left — about & themes */}
            <div className="home-split__left">
              <span className="label-tag">About the summit</span>
              <h2>Where quantum<br />meets security.</h2>
              <p>
                Q-DEF is Luxembourg's premier summit on quantum technologies and national defense.
                One day, three tracks, and the experts who are defining the future.
              </p>
              <div className="home-split__themes">
                {['Quantum Computing', 'Post-Quantum Crypto', 'Cyber Defense', 'AI & Defense', 'Quantum Sensing', 'Policy & Ethics'].map(t => (
                  <span className="theme-pill" key={t}>{t}</span>
                ))}
              </div>
              <div style={{ display: 'flex', gap: '1rem', marginTop: '2rem', flexWrap: 'wrap' }}>
                <Link to="/register" className="btn btn-gradient">Get Your Ticket</Link>
                <Link to="/about" className="btn btn-outline-glow">Learn More</Link>
              </div>
            </div>

            {/* Right — tinder-style stacked speaker cards */}
        ...
        <div className="container">
          <div className={a('stands')}>
            <div className="section-header" style={{ textAlign: 'left' }}>
              <span className="label-tag">Exhibition Hall</span>
              <h2>12 stands to explore.</h2>
              <p className="section-subtitle">Meet the companies building the future of quantum defense.</p>
            </div>
            <div className="stands-grid">
              {[
                { name: 'IBM Quantum', desc: 'Quantum computing platforms & enterprise solutions', img: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=400&q=80', tag: 'Quantum Computing' },
                { name: 'Thales', desc: 'Cybersecurity, defense electronics & quantum-safe encryption', img: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=400&q=80', tag: 'Defense' },
                { name: 'Pasqal', desc: 'Neutral atom quantum processors for defense applications', img: 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=400&q=80', tag: 'Quantum Hardware' },
                { name: 'CrowdStrike', desc: 'AI-native cybersecurity & threat intelligence platform', img: 'https://images.unsplash.com/photo-1563986768609-322da13575f2?w=400&q=80', tag: 'Cybersecurity' },
                { name: 'Airbus Defence', desc: 'Satellite communications & secure defense systems', img: 'https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?w=400&q=80', tag: 'Aerospace' },
                { name: 'IQM', desc: 'European quantum computers for research & industry', img: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=400&q=80', tag: 'Quantum Hardware' },
                { name: 'Palo Alto Networks', desc: 'Next-gen firewalls & zero trust security architecture', img: 'https://images.unsplash.com/photo-1510511459019-5dda7724fd87?w=400&q=80', tag: 'Cybersecurity' },
                { name: 'Rheinmetall', desc: 'Defense technology, electronics & autonomous systems', img: 'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=400&q=80', tag: 'Defense Tech' },
                { name: 'QuSecure', desc: 'Post-quantum cryptography solutions for enterprises', img: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=400&q=80', tag: 'PQC' },
                { name: 'Scale AI', desc: 'AI data platform for defense & intelligence applications', img: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=400&q=80', tag: 'AI & Defense' },
                { name: 'LuxProvide', desc: "Luxembourg's HPC & quantum computing national center", img: 'https://images.unsplash.com/photo-1597733336794-12d05021d510?w=400&q=80', tag: 'HPC' },
                { name: 'Leonardo', desc: 'Defense, security, aerospace electronics & cyber systems', img: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=400&q=80', tag: 'Defense' },
              ].map((stand, i) => (
                <div className="stand-card" key={i} style={{ animationDelay: `${i * 0.06}s` }}>
                  <div className="stand-card__img-wrap">
                    <img src={stand.img} alt={stand.name} className="stand-card__img" loading="lazy" />
                    <span className="stand-card__tag">{stand.tag}</span>
                  </div>
                  <div className="stand-card__body">
                    <h3 className="stand-card__name">{stand.name}</h3>
                    <p className="stand-card__desc">{stand.desc}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="section section-dark" ref={r('prog')} data-s="prog">
        <div className="container">
          <div className={a('prog')}>
            <div className="section-header" style={{ textAlign: 'left' }}>
              <span className="label-tag">Programme</span>
              <h2>Full-day schedule.</h2>
              <p className="section-subtitle">Keynotes, panels, workshops, and networking — all in one day.</p>
            </div>
            <div className="programme-preview-grid">
              {(sessions.length > 0 ? sessions : FALLBACK_PROGRAMME.filter(s => s.type !== 'break')).slice(0, 8).map((s, i) => (
      ...
      <section className="cta-banner">
        <div className="container cta-banner__inner">
          <div>
            <h3 className="cta-banner__title">Limited seats available.</h3>
            <p className="cta-banner__desc">Join us November 25, 2026 at Maison du Savoir.</p>
          </div>
          <Link to="/register" className="btn btn-gradient btn--lg">Reserve Your Seat</Link>
        </div>
      </section>
      ...
      <section className="section" ref={r('feat')} data-s="feat">
        <div className="container">
          <div className={a('feat')}>
            <div className="section-header" style={{ textAlign: 'left' }}>
              <span className="label-tag">Key themes</span>
              <h2>Three pillars of<br />quantum defense.</h2>
            </div>
            <div className="feature-cards-grid">
              {[
                { img: 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=600&q=80', title: 'Quantum Threat Intelligence', desc: 'Understanding the quantum threat to encryption and national security.' },
                { img: 'https://images.unsplash.com/photo-1563986768609-322da13575f2?w=600&q=80', title: 'Cyber Defense Operations', desc: 'AI-powered defense, real-time threat response, and next-gen strategies.' },
                { img: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=600&q=80', title: 'Post-Quantum Cryptography', desc: 'Deploying quantum-safe algorithms for classified communications.' },
              ].map((c, i) => (
                <div className="feature-card" key={i}>
                  <div className="feature-card__bg" style={{ backgroundImage: `url(${c.img})` }} />
      ...
      {/* ===== FINAL CTA ===== */}
      <section className="section-cta" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=1920&q=80)' }}>
        <div className="section-cta__overlay" />
        <div className="container section-cta__content">
          <h2 className="section-cta__title" style={{ color: '#fff' }}>Secure your place.</h2>
          <p className="section-cta__desc" style={{ color: 'rgba(255,255,255,0.7)' }}>
            Join 300+ leaders shaping the future of quantum defense in Europe.
          </p>
          <Link to="/register" className="btn btn-gradient btn--lg">Attend the Event</Link>
        </div>
      </section>
        ...
        <div className="container">
          <div className={a('part')}>
            <div className="section-header">
              <span className="label-tag">Partners</span>
              <h2>Trusted by leaders.</h2>
            </div>
            <div className="partners-row">
              {['NATO', 'European Commission', 'Luxembourg MoD', 'ESA', 'EDA', 'Thales', 'Airbus Defence', 'IBM Quantum'].map(p => (
                <div className="partner-logo glass-card" key={p}>{p}</div>
              ))}
            </div>
          </div>
        </div>
